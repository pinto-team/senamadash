...
export function RelationshipTab({ form, mode }: Props) {
    ...
    return (
        <TabsContent value="relationship" className="mt-6 space-y-6">
                    ...
                    render={({ field }) => (
                        ...
                        >
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="past">{t('partners.enums.partnership_status.past')}</SelectItem>
                                <SelectItem value="present">{t('partners.enums.partnership_status.present')}</SelectItem>
                                <SelectItem value="future">{t('partners.enums.partnership_status.future')}</SelectItem>
                            </SelectContent>
                        </Select>
                    )}
                />
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        ...
                        >
                            ...
                            <SelectContent>
                                <SelectItem value={EMPTY}>—</SelectItem>
                                <SelectItem value="good">{t('partners.enums.credit_status.good')}</SelectItem>
                                <SelectItem value="normal">{t('partners.enums.credit_status.normal')}</SelectItem>
                                <SelectItem value="bad">{t('partners.enums.credit_status.bad')}</SelectItem>
                            </SelectContent>
                        </Select>
                    )}
                />
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        ...
                        >
                            ...
                            <SelectContent>
                                <SelectItem value={EMPTY}>—</SelectItem>
                                <SelectItem value="price">{t('partners.enums.sensitivity.price')}</SelectItem>
                                <SelectItem value="quality">{t('partners.enums.sensitivity.quality')}</SelectItem>
                                <SelectItem value="speed">{t('partners.enums.sensitivity.speed')}</SelectItem>
                                <SelectItem value="brand">{t('partners.enums.sensitivity.brand')}</SelectItem>
                                <SelectItem value="other">{t('partners.enums.sensitivity.other')}</SelectItem>
                            </SelectContent>
                        </Select>
                    )}
                />
            ...
            <div>
                <label className="text-sm font-medium">
                    {t('partners.form.notes')}
                </label>
                <Textarea disabled={isView} {...register('relationship.notes')} />
            </div>
        </TabsContent>
    )
}
